...
namespace AdministradorTareas
{
    class ListaProcesos
    {
        ...
        public void IniciaLista()
        {
            ...
            Procesos dt1 = new Procesos(nombreProceso[num.Next(0,9)], num.Next(0,1620), "Ejecutando", tipoProceso[num.Next(0,2)], num.Next(1, 50), num.Next(1, 300), num.Next(0, 10), desc[num.Next(0,3)], num.Next(15,90));
